...
namespace ASL.Scanning.Tango
{
    public class RoomSaveLogic : MonoBehaviour
    {
        #region Fields
        /// <summary>
        /// Determines if the RoomSaveLogic logic has run initialization, usually through a call to the Editor window. This serves as a simple indication whether the variables have been initialized.
        /// </summary>
        ...
        {
            // Does not trigger in Editor - bug with Unity
            Initialized = false;
        }
