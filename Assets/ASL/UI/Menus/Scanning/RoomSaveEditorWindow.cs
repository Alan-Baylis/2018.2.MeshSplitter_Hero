...
namespace ASL.UI.Menus.Scanning
{
    ...
    {
        public static ASL.Scanning.Tango.RoomSaveLogic roomSaveLogic_m;
        ...
        public static ASL.Scanning.Tango.RoomSaveLogic SetRoomSaveLogicScript()
        {
        ...
        {
            if (roomSaveLogic_m == null)
            {
                RoomSaveEditorWindow.SetRoomSaveLogicScript();
            }
            if(roomSaveLogic_m != null)
            {
                if (!roomSaveLogic_m.Initialized)
                {
                    roomSaveLogic_m.Startup();
                }
            }
